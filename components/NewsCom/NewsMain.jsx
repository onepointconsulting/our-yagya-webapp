...
const newsCategoriesAdapter = (globalProperties) => {
    const resArray = globalProperties?.data.filter(
        (gb) => gb.attributes.key === 'newsCategories').
...
const NewsItem = ({news, locale}) => {
    ...
    return (
        ...
        >
            <div
                className="text-redfull py-2 text-[19px] md:text-[26px] xl:text-[30px]">
                <a href="/news_details.html">{news.title}</a>
            </div>
            <div>
                <div
                    className="flex items-center text-sm text-gray-700 md:text-base lg:text-xl xl:text-2xl">
...
const AccordionItem = ({pos, openPosition, setOpenPosition, subCategory}) => {

    const openBody = "500px";
    ...
    return (
        <div
            className="w-full my-2 md:m-2 md:ml-auto">
            <div
                ...
                <div
                    className="mb-0 cursor-pointer text-gold1">
            ...
            <div
                className="overflow-hidden bg-gray-200 accordionChildBody" style={{ maxHeight: maxHeightChildBody }}>
                <div
                    className="p-2 pl-4 mb-8 metropolis_medium md:pl-8 md:p-4">
                    <div
                        className="text-redfull py-2 text-[19px] md:text-[26px] xl:text-[30px]">
                        <a href="/news_details.html">
                            Recordings of Global
                            Silence Retreat
                            *(November
                            19-20) now availabe
                        </a>
                    ...
                    <div>
                        <div
                            className="flex items-center text-lg text-gray-700 md:text-xl xl:text-2xl">
                            <div
                                className="mr-2">posted
                            </div>
                            <div
                                className="mx-2">19-20
                                November
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        className="py-2 text-lg text-redfull md:text-2xl xl:text-3xl">
                        <a href="/news_details.html">Avyakt
                            BapDada</a>
                    </div>
                    <div>
                        <div
                    ...
                    <div
                        className="py-2 text-lg text-redfull md:text-2xl xl:text-3xl">
                        <a href="/news_details.html">Dewali
                            Festival</a>
                    </div>
                    <div>
                        <div
...
export default function NewsMain ({ data }) {
    ...
    console.log('NewsMain adaptedNews', JSON.stringify(adaptedNews))
    return (
        <div>
            {/* <!-- parent --> */}
            <div
            ...
            >
                ...
                <div className="w-auto  mb-8 fadeInTop lg:w-full mx-atuo">
                    ...
                    <div className="object-cover bg-gray-200 bg-opacity-[0.50]">
                        <div
                            className="py-2 pl-4 pr-2 text-[2rem] text-slate-50 capitalize filosofia_italic bg-button-color bg-gold1 md:text-4xl">
                            {newsCategories[0]}
                        </div>
                        {adaptedNews[newsCategories[0]]?.news.map((news, i) => <NewsItem news={news} locale={locale} key={`news_item_${i}`} />)}
                ...
                <div className="lg:flex justify-between">
                    <div className="lg:mr-4 flex flex-col items-center">
                        ...
                        <div className="relative w-full my-4 bg-gray-200 h-fit">
                            ...
                            {adaptedNews[newsCategories[1]]?.news.map(
                                (news, i) => <NewsItem news={news} locale={locale} key={`news_item_${i}`} /> )}
                            <div className="my-8">
                                <h1 className="flex justify-center mt-4 text-5xl text-center text-gray-400 cursor-poainter">
                                    <img
                                        className="w-8 md:w-12"
                        ...
                        <div className="w-full">
                            ...
                            <div className="relative w-full my-4 h-fit">
                                <div
                                    className="flex items-center mb-0 text-slate-50 cursor-pointer bg-gold1 filosofia_italic">
                                    <div
                                        className="py-2 pl-4 pr-2 text-[2rem] text-slate-50 capitalize filosofia_italic bg-button-color bg-gold1 md:text-4xl">
                                        {newsCategories[3]}
                                    </div>
                                ...
                                {/* <!--accordion child--> */}
                                <NestedAccordion news={adaptedNews} newsCategory={newsCategories[3]} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:ml-4 flex flex-col items-center">
                        ...
                        <div className="relative w-full my-4 bg-gray-200 h-fit">
                            ...
                            {adaptedNews[newsCategories[2]]?.news.map(
                                (news, i) => <NewsItem news={news} locale={locale} key={`news_item_${i}`} /> )}
                            <div className="my-8">
                                <h1 className="flex justify-center mt-4 text-5xl text-center text-gray-400 cursor-poainter">
                                    <img
                        ...
                        <div className="relative w-full my-4 bg-gray-200 h-fit">
                            ...
                            <div
                                ...
                                <div
                                    className="text-redfull py-2 text-[19px] md:text-[26px] xl:text-[30px]">
                                    <a href="/news_details.html">
                                        Recordings of Global Silence Retreat
                                        *(November 19-20) now
                                        availabe
                                    </a>
                                </div>
                                <div>
                                    <div
                                        ...
                                        <div className="mx-2">19-20 November
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div
                                        className="flex items-center text-sm text-gray-700 md:text-base lg:text-xl xl:text-2xl">
                                        <div className="mr-2">posted</div>
                                        <div className="mx-2">10-11 November
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="relative w-full my-4 bg-gray-200">
                            <div
                                className="flex items-center justify-between w-full bg-gold1 h-fit">
                                <div className="flex lg:block">
                                    <div
                                        className="p-2 text-[2rem] text-slate-50 filosofia_italic md:text-4xl xs:pl-2 md:pl-8">
                                        for, CCs, NCs, NCTs,
                                    </div>
                                    <div
                                        className="p-2 text-[2rem] text-slate-50 filosofia_italic md:text-4xl xs:pl-2 md:pl-8">
