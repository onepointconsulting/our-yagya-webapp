...
export default function NewsMain ({ data }) {
    ...
    console.log('newsCategories', newsCategoriesAdapter(globalProperties))
                ...
                <div className="w-auto mx-2 mb-8 fadeInTop lg:w-full lg:mx-16">
                    <div className="object-cover bg-gray-200 bg-opacity-[0.50]">
                        ...
                        <div
                            ...
                            <div
                                className="text-redfull py-2 text-[19px] md:text-[26px] xl:text-[30px] mt-2">
                    ...
                    <div className="w-full md:ml-auto">
                        ...
                        <div className="justify-between w-full my-4 lg:flex">
                            <div className="w-full max-w-auto lg:w-[48%]">
                                ...
                                <div
                                    className="relative w-full pb-16 my-4 bg-gray-200 fadeInLeft h-fit">
                                    <div
                                        className="py-2 pl-4 pr-2 text-[2rem] text-slate-50 capitalize filosofia_italic bg-button-color bg-gold1 md:text-4xl">
                                        Madhuban news
                                    </div>
                                    <div
                                        ...
                                        <div
                                            className="text-redfull py-2 text-[19px] md:text-[26px] xl:text-[30px] mt-2">
                                            <a href="/news_details.html">
                                                Recordings of Global Silence
                                                Retreat *(November 19-20)
                                                now availabe
                                            </a>
                                        </div>
                                        <div>
                                            <div
                                                className="flex items-center text-sm text-gray-700 md:text-base lg:text-xl xl:text-2xl">
                                                <div className="mr-2">posted
                                                </div>
                                                <div className="mx-2">19-20
                                                    November
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div
                                className="fadeInRight w-full max-w-auto lg:w-[48%]">
                                {/* <!-- right section (first box) --> */}
                                <div
                                    className="relative w-full pb-16 my-4 bg-gray-200 h-fit">
                                    <div
                                        className="py-2 pl-4 pr-2 text-[2rem] text-slate-50 capitalize filosofia_italic bg-button-color bg-gold1 md:text-4xl">
                                        special focus news
                                    </div>
                        ...
                        <div className="justify-between w-full my-4 lg:flex">
                            <div
                                className="w-full max-w-auto lg:w-[48%] lg:mt-[-22rem] xl:mt-[-22rem] 2xl:mt-[-19rem]">
