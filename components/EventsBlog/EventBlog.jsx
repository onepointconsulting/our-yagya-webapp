      ...
      {eventDetailsData.map((data, index) => (
          <div
            ...
            <div className="w-full">
              ...
              <div className="w-full">
                ...
                <div className="py-8">
                  <Link href={`/single_event/${data.id}`}>
                    <h1
                      className="text-xl font-medium text-red-500 md:text-3xl lg:text-4xl xl:text-5xl cursor-pointer">
                      {data.title}
                    </h1>
            ...
            <div className="w-32 md:w-36 lg:w-72">
              ...
              {/* Live link button. TODO: if the event is not live display gray other wise activate button*/}
              {!!data.liveLink && <div
                className="flex rounded-md bg-pinkFull items-center text-center my-1 xl:my-2 px-1 xl:px-2 py-1 xl:py-2 cursor-pointer">
                <div>
                  <img className="w-4 xs:w-6 lg:w-12"
