  ...
  return (
    <Parallax speed={-5} className="lg:flex mt-3 mb-3 lg:px-6 py-8">
      <div
        ...
        <div
          className="bg-button-color capitalize p-2 md:p-4 text-Filosofia italic">
          <h1
            className="filosofia_italic text-white ml-auto text-2xl md:text-4xl lg:ml-5">
            {t(' Links directory')}
          </h1>
        </div>
        ...
        <div
          ...
          <div className="absolute bottom-4 right-0 left-0">
            <h1
              className="cursor-poainter text-5xl mt-4 flex justify-center text-gray-400 text-center">
              <Link href="/links">
      ...
      {/* <!-- video preview --> */}
      <div
        className="bg-video-pre-color mb-8 md:mb-auto md:w-11/12 lg:ml-2 mr-4 ml-4 md:mr-auto md:ml-auto">
        {/* <!--  featured title --> */}
        <div
          className="bg-button-color capitalize p-2 md:p-4 text-Filosofia italic">
          <h1
            className="filosofia_italic text-white ml-auto text-2xl md:text-4xl">
            {t(' featured videos')}
          </h1>
        </div>
        ...
        {/* <!-- Videw section --> */}
        <div
          className="metropolis_medium bg-video-pre-color ml-3 mr-3 lg:mr-0 lg:ml-0 mt-2">
          <div className="w-auto max-w-auto p-auto md:p-4 xl:p-16 mx-auto">
            ...
            <div
              className="flex justify-between items-center pb-6 pt-2 text-xs sm:text-sm md:text-xl">
              <div>
