  ...
  return (
    <div
      ...
      >
        ...
        >
          <div
            className="lg:hidden inline-block cursor-pointer p-[5px] bg-white rounded-full  border-[1px] border-red-600">
            <img
        ...
        <div className="w-full" style={{ zIndex: '3' }}>
          ...
          <Link href="/">
            <div className="bg-white w-full relative cursor-pointer">
              ...
              {/* <!-- title and subtitle --> */}
              <div
                className="flex flex-wrap justify-center items-center absolute bottom-0 left-0 right-0 pb-[9px]">
                <h1
                  className="text-gold1 font-extrabold uppercase text-2xl md:text-3xl lg:text-5xl text-center"
                  style={{ lineHeight: '1' }}>
                  {title}
                </h1>
              </div>
