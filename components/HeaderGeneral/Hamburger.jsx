...
const Hamburger = () => {
  return (
    <div
      className="absolute top-4 xs:top-6 md:top-8 right-4 sm:right-10 h-16 w-16 lg:hidden z-30 ">
      <Link href="/" className="inline-block float-right text-yagya-red-color">
