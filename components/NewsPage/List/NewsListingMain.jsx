...
export default function NewsListingMain() {
    ...
    return (
        <div className="mt-4 fadeInLeft md:-mt-4 lg:mt-36">
                    ...
                    >
                        <div className="flex items-center w-auto">
                            <div className="relative w-24 h-20 md:w-64 md:h-36">
                                <img src="https://cdn.esawebb.org/archives/images/screen/weic2216b.jpg" className="absolute object-cover w-full h-full" />
                            </div>

                            <div className="py-2 pl-4 break-words w-52 xs:w-64 md:w-full md:truncate">
                                <h1
            ...
            <h1 className="flex justify-center my-20 text-6xl text-center text-gray-700 cursor-pointer md:my-10">
                <Link href="#">
                    <a>
                        <img className="w-8 xs:w-10 md:w-12" src="/img/icons/ArrowDown.png" alt="" />
                    </a>
                </Link>
            </h1>
        </div>
