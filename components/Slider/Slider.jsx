...
export default function Slider() {
  ...
  const { data } = Object.keys(useContext(IndexContext).data).length === 0 ? useContext(NewsContext) && useContext(EventsContext) : useContext(IndexContext);
      ...
      {slides.map((slide) => {
        ...
        return (
          <SplideSlide className="splide__slide" key={slide.id}>
            <div className="w-full max-w-full mx-auto overflow-hidden shadow-md metropolis_medium bg-redD50">
              <div className="items-center justify-between md:flex">
                ...
                <div className="w-full md:pl-14">
                  <div className="pl-4 description pr-1 sm:pr-0 sm:pl-0 text-lg md:text-2xl xl:text-[32px] my-1 sm:my-4 text-gray-500 capitalize">
                    {slide.title}
                    <br />
                  ...
                  <div className="items-end justify-between mb-4 lg:flex sm:items-center">
