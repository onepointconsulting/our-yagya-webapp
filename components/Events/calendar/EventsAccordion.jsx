  ...
  return (
    <div className="w-32 md:w-36 lg:w-72">
      <MoreInfo event={event}
                mainClass="flex rounded-md bg-gold1 my-1 xl:my-2 px-1 xl:px-2 py-1 xl:py-2 cursor-pointer events-center"
                imgClass="w-4 xs:w-6 lg:w-12"
                moreInfoClass="md:pl-3 lg:pl-4 text-[9px] md:text-lg lg:text-xl xl:text-2xl text-white"/>

      {/* Register link button */}
      <div
        className="flex rounded-md bg-gold1 events-center text-center my-1 xl:my-2 px-1 xl:px-2 py-1 xl:py-2 cursor-pointer">
        <div>
          <img
          ...
          {activeIndex === index && (
            ...
            >
              <div
                ...
                {/* <!-- img --> */}
                <div
                  className="relative flex justify-between events-end flex-col w-full lg:w-max">
