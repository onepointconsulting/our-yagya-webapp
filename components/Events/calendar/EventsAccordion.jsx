...
const ButtonsAccordion = () => {
  ...
  return (
    <div className="w-32 md:w-36 lg:w-72">
      ...
      <div className="flex rounded-md bg-gold1 items-center text-center my-1 xl:my-2 px-1 xl:px-2 py-1 xl:py-2 cursor-pointer">
        <div>
          <img
            className="w-4 xs:w-6 lg:w-12"
          ...
          {activeIndex === index && (
            ...
            >
              <div className="flex flex-col-reverse justify-between p-3 lg:flex-row xl:p-5">
                ...
                {/* <!-- img --> */}
                <div className="relative flex justify-between items-end flex-col w-full lg:w-max">
