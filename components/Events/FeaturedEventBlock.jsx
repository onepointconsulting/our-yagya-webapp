    ...
    return (
        <div className="flex pt-3">
            <div className="w-full pb-4">
                <Link href="/calendar_events.html">
                    <div
                        ...
                        <div className="w-20 xs:w-24 xl:w-32">
                            ...
                            <div
                                className="flex items-center px-1 py-1 my-1 text-center rounded-lg cursor-pointer bg-gold1">
                                <div>
                                    <img
                                        className="w-4 xs:w-6 lg:w-7"
                                ...
                                <div
                                    className="pl-2 pr-2 m-auto mt-auto mb-auto text-xs text-center text-slate-50 onlnie_eve_title lg:text-sm xl:text-base">
                                    Register
                                </div>
                            </div>
                        </div>
