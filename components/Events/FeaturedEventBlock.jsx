              ...
              <div className="flex items-center w-auto md:w-4/5 lg:w-5/6 xl:w-5/6">
                ...
                <div className="w-[40vw] md:w-[72%] lg:w-full pl-2 md:pl-4 lg:pl-8">
                  ...
                  <div className="items-center justify-between w-full md:flex">
                    ...
                    <div>
                      <p className="leading-6 text-[10px] text-gray-400 md:text-[1rem] lg:text-[1.125rem]">
                        {formateDate(event.date, locale, "hh:mm a")}{" "}
                        {event.timezone}
                      </p>
                    </div>
                  </div>
...
export default function FeaturedEventBlock({
  ...
  return (
    <div className="flex items-center justify-center w-full mt-28 md:mt-36 lg:mt-52 bg-white bg-opacity-95">
      <div className="relative w-full h-full ml-auto mr-auto bg-white lg:m-4 md:w-11/12 lg:w-10/12">
