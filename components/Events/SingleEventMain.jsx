...
const Venue = ({ singleEvent }) => {
  return (
    <div
      className="p-2 text-sm leading-normal text-left text-gray-400 md:text-lg lg:text-xl ">
      <p>
        {' '}
...
const EventImage = ({ singleEvent }) => {
  ...
  return (
    <div className="relative mx-auto w-[84%] h-full">
      ...
      <div className="flex items-start justify-between w-fit xl:p-2">
        ...
        <div className="flex flex-col mx-2">
          ...
          <h3
            ...
            {singleEvent.sOnlineStatus?.includes('inhouse') &&
    ...
    <div className="my-2 lg:my-4 lg:p-4 flex justify-between w-full">
      <div
        ...
        <div className="w-fulln">
          <h4
            className="text-sm text-left capitalize text-slate-50 md:text-base lg:text-xl">
        ...
        <div className="flex flex-col mx-2">
          ...
          <div
            ...
            <div className="flex items-center justify-between w-full my-2">
              ...
              <div className="ml-4 w-36 md:w-48 xl:w-60">
                {' '}
                {formateDate(singleEvent.sStartDate, locale,
                  'hh:mm a')} - {formateDate(singleEvent.sEndDate, locale,
                'hh:mm a')}
              </div>
            </div>
          </div>
      ...
      <div className="flex items-start justify-between w-fit xl:p-2">
        ...
        <div className="flex flex-col mx-2">
          ...
          {singleEvent.joinLink && (
            <>
              <h1
                className="text-lg text-left text-gold1 sm:text-xl md:text-2xl">
                {t('Registration')}?{' '}
              </h1>
              <p
                className="text-sm leading-normal text-left text-gray-400 md:text-lg lg:text-xl ">
                ...
                <Link href={singleEvent.joinLink}
                      className="text-sm lg:text-base" target="_blank">
                  {singleEvent.joinLink}
                </Link>
              </p>
            </>
        ...
        <div className="w-full mx-auto bg-slate-50 xl:w-10/12 bg-opacity-95">
          ...
          <div className="border border-gray-400">
            <div className="filosofia_italic bg-gold1">
              <h1
                className="p-2 text-xl text-center md:p-4 text-slate-50 sm:text-2xl md:text-4xl lg:text-5xl lg:p-7">
