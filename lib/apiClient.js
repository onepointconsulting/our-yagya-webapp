...
export async function calendarLayout ({ locale, resolvedUrl }) { 
  ...
  const baseLayoutPromise = baseEventsLayout(locale, resolvedUrl, false)
  ...
  console.log('calendarEventsUrl', calendarEventsUrl)
...
async function baseEventsLayout (locale, resolvedUrl, hasSlider = true) {
